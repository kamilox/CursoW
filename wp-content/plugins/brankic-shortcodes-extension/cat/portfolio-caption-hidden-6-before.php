...
<?php if ($style == "masonry") { ?>
						...
						<div id="<?php echo $brankic_cat_id; ?>" class="col<?php echo $columns ?> <?php echo esc_attr($image_zoom_effect . " " . $shadow_color_class . " " . $fig_hid_alignment . " " . $fig_hid_position); ?> fig_hid hover6 p_cat" <?php echo $data_columns_tablet; ?> <?php echo $data_columns_phone; ?> <?php echo $img_radius_size_data; ?> <?php echo $data_gap; ?>>
...
if ($style == "flex") { ?>
						...
						<div id="<?php echo $brankic_cat_id; ?>" class="p-flex col<?php echo $columns ?>  <?php echo esc_attr($image_zoom_effect . " " . $shadow_color_class . " " . $fig_hid_alignment . " " . $fig_hid_position); ?> fig_hid hover6 p_cat" <?php echo $data_columns_tablet; ?> <?php echo $data_columns_phone; ?> <?php echo $flex_height; ?> <?php echo $img_radius_size_data; ?> <?php echo $data_gap; ?>>

<?php }	

if ($style == "grid") { ?>

						<div id="<?php echo $brankic_cat_id; ?>" class="p-flex col<?php echo $columns ?> <?php echo esc_attr($image_zoom_effect . " " . $shadow_color_class . " " . $fig_hid_alignment . " " . $fig_hid_position); ?> fig_hid hover6 p_cat" <?php echo $data_columns_tablet; ?> <?php echo $data_columns_phone; ?> <?php echo $img_radius_size_data; ?> <?php echo $data_gap; ?>>

<?php }		

if ($style == "grid_advanced") { ?>

						<div id="<?php echo $brankic_cat_id; ?>" class="grider <?php echo esc_attr($image_zoom_effect . " " . $shadow_color_class . " " . $fig_hid_alignment . " " . $fig_hid_position); ?> fig_hid hover6 p_cat" <?php echo $img_radius_size_data; ?> <?php echo $data_columns_tablet; ?> <?php echo $data_columns_phone; ?> data-column="<?php echo $columns; ?>" <?php echo $data_gap; ?> <?php echo $data_grid_advanced_row_height; ?>>
