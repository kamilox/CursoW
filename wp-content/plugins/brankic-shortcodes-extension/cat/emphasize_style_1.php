                        ...
                        <article <?php post_class(array($wow_class, "emphasize-post-split")); ?> <?php echo $wow_delay; ?>>
									...
									<div class="emphasize-post-media <?php echo $duotone; ?>">
										...
										<a href="<?php the_permalink(); ?>"><div class="emphasize-background-image" style="background-image: url(<?php echo $featured_image[0]; ?>);"></div></a>
										<?php } ?>
