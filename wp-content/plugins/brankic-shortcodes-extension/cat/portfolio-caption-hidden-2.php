...
if (isset($custom_title_colors_array[$i]) || isset($custom_title_hovers_array[$i])) {
	$custom_css = '.fig_hid.hover2 article:nth-child(' . $j . ') .entry-title {color: ' . $custom_title_color . ';}
.fig_hid.hover2 article:nth-child(' . $j . ') .post-info {background:' . $custom_hover_color  . '}'; 
