...
if (isset($custom_category_colors_array[$i])) $custom_category_color = $custom_category_colors_array[$i]; else $custom_category_color = $category_color;
...
if (isset($custom_title_colors_array[$i]) || isset($custom_title_hovers_array[$i])) {
	$custom_css = '.fig_hid.hover5 article:nth-child(' . $j . ') .entry-category, .fig_hid.hover5 article:nth-child(' . $j . ') .entry-category a {color: ' . $custom_category_color . ';}
.fig_hid.hover5 article:nth-child(' . $j . ') .inner-holder:after {background:' . $custom_hover_color  . '}'; 
