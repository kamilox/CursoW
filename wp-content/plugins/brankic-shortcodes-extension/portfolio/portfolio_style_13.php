...
?>
        <div class="main-container brankic_portfolio_content <?php echo $portfolio_item_style; ?>">
            ...
            <div class="row-container brankic_hero <?php echo $row_extra_padding_class; ?> <?php echo $change_header_colors_class; ?> <?php echo $change_header_colors_below_class; ?>">
					...
					<?php //} ?>
						...
						<div class="row-bg-wrap">
                            <div class="inner-wrap"> 
                               <div class="row-bg background-image  <?php echo $parallax; ?>"><div class="<?php echo $portfolio_item_duotone; ?>">
            ...
            <?php if ($extra_images_layout != "" && $featured_images_limit) { ?>
			<?php
