...
function check_light(){
	var $active_slide = jQuery(".fp-section.active");
	
	if($active_slide.find(".dark").length ) {

		jQuery("#primary-menu").addClass("light-mode light");
		jQuery("#secondary-menu").addClass("light-mode light");
		jQuery("#fp-nav").addClass("light");
		jQuery("#light-logo").css("display", "inline");
		jQuery("#dark-logo").css("display", "none");
	} else{		
		jQuery("#primary-menu").removeClass("light-mode light");
		jQuery("#secondary-menu").removeClass("light-mode light");
		jQuery("#fp-nav").removeClass("light");
		jQuery("#light-logo").css("display", "none");
		jQuery("#dark-logo").css("display", "inline");		
	};
}