...
jQuery(window).load(function() {
	 if (jQuery(".page .extra_padding").length > 0) {
		var header_height = jQuery(".header.header_default").outerHeight();
		jQuery(".extra_padding .vc_row:first").css("padding-top", header_height + "px");
		jQuery(".extra_padding .vc_row:first").css("padding-bottom", header_height + "px");
	} 
