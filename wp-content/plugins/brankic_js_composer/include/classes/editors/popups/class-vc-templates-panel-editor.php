...
class Vc_Templates_Panel_Editor {
	...
	public function renderTemplateBlock( $category ) {
		if ( 'my_templates' === $category['category'] ) {
			...
			if ( 'default_templates' === $category['category'] ) {
				...
				$category['output'] .= '
				<div class="vc_column vc_col-sm-12">
				<ul class="brankic_template_filters">
					<li style="display:inline"><a href="#" data-cat="bra_all">All</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_about">About</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_blog">Blog</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_boxes">Boxes</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_cta">Call to Action (CTA)</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_clients">Clients</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_contact">Contact / Map</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_counters">Counters</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_hero">Hero Holder</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_icons">Icons</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_image">Images</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_portfolio">Portfolio</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_progress">Progress Bar</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_tabs">Tabs / Accordions</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_team">Team</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_testimonials">Testimonials</a></li>					
					<li style="display:inline"><a href="#" data-cat="bra_text">Text Block</a></li>	
					<li style="display:inline"><a href="#" data-cat="bra_services">Services</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_sliders">Sliders</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad01">Myriad01</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad02">Myriad02</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad03">Myriad03</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad04">Myriad04</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad05">Myriad05</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad06">Myriad06</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad07">Myriad07</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad08">Myriad08</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad09">Myriad09</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad10">Myriad10</a></li>
				</ul>
				<ul class="brankic_template_filters">					
					<li style="display:inline"><a href="#" data-cat="bra_myriad11">Myriad11</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad12">Myriad12</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad13">Myriad13</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad14">Myriad14</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad15">Myriad15</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad16">Myriad16</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad17">Myriad17</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad18">Myriad18</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad19">Myriad19</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad20">Myriad20</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad21">Myriad21</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad22">Myriad22</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad23">Myriad23</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad25">Myriad25</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad26">Myriad26</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad27">Myriad27</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad28">Myriad28</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad29">Myriad29</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad30">Myriad30</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad31">Myriad31</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad32">Myriad32</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad33">Myriad33</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad34">Myriad34</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad35">Myriad35</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad36">Myriad36</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad37">Myriad37</a></li>
					<li style="display:inline"><a href="#" data-cat="bra_myriad38">Myriad38</a></li>
				</ul>
					<div class="brankic_template vc_ui-template-list vc_templates-list-default_templates wpb-content-layouts vc_ui-list-bar" data-vc-action="collapseAll">';				
				//end brankic1979
	...
	public function getAllTemplates() {
		...
		//Brankic1979 replaced the word Default in lines 616 and 617
		$default_templates = $this->getDefaultTemplates();
		if ( ! empty( $default_templates ) ) {
			$arr_category = array(
				'category' => 'default_templates',
				'category_name' => esc_html__( 'Brankic1979 Templates', 'js_composer' ),
				'category_description' => esc_html__( 'Append Brankic1979 template to the current layout.', 'js_composer' ),
				'category_weight' => 11,
			);
			$category_templates = array();
	...
	public function renderTemplateListItem( $template ) {
		...
		//start brankic1979 and below <img src="$image_path"> line 919
		$image_path = esc_attr( isset( $template['image'] ) ? $template['image'] : '' ); 
		//end brankic1979
		$output = <<<HTML
