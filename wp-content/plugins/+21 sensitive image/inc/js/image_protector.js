...
$(document).ready(function(){
    ...
    if(localStorage.getItem('age' ) != '21'){
        ...
        $(
            ...
            +'</div>' //button-protected
            +'</div>'//image-protected
        ).insertBefore('.sensitive .elementor-container .elementor-row .elementor-column .elementor-column-wrap .elementor-widget-wrap .elementor-element .elementor-widget-container .elementor-swiper');
        ...
        $(
            ...
            +'</div>' //button-protected
            +'</div>'//image-protected
        ).insertBefore('.sentive-each .elementor-container .elementor-row .elementor-column .elementor-column-wrap .elementor-widget-wrap .elementor-section .elementor-container .elementor-row .elementor-column .elementor-column-wrap .elementor-widget-wrap .elementor-element .elementor-widget-container .elementor-image');
