function addNewRow(id){var Nid=parseInt(id.split('-').pop());var NGalID=parseInt(Nid+1);$('<div class="gallery-container" id="id-'+NGalID+'" >'
...
+'<input type="button" class="button button-secondary button-load-before" id="button-before'+NGalID+'" value="Upload File" onclick="imageBefore('+"'"+'button-load-before'+"'"+','+"'"+'x'+"'"+')"/>'
...
+'</div>'
+'<div class="button-container">'
+'<input type="button" class="button button-secondary button-load-after" id="button-after'+NGalID+'" name="button-after" value="Upload File" onclick="imageAfter('+"'"+'button-load-after'+"'"+','+"'"+'y'+"'"+' )"/>'
