...
+'</div>'
+'</div>');$('.button-yes').click(function(){localStorage.setItem('age','21');$('.image-protected').css('display','none');});$('.button-no').click(function(){console.log('no');});}else{$('.image-protected').css('display','none');}});