...
if (brankic_of_get_option("smooth_scroll", brankic_of_get_default("smooth_scroll")) == "yes") $data_smooth_scroll = 'data-smooth-scroll="true"'; else $data_smooth_scroll = ";" ?>
    <div class="wrapper-holder lateral-hidden-toggle menu-lateral-hidden-toggle" <?php echo wp_kses($data_smooth_scroll, $brankic_allowedposttags); ?>>
	
<?php
include(get_template_directory() . '/inc/header_lateral-toggle-right-hidden.php');
...
?> 	
            ...
            <div class="main-container">
                ...
                <div class="row-container <?php echo esc_attr($default_index_margin) . " " . $default_index_padding; ?>" <?php echo esc_attr($style); ?>>
